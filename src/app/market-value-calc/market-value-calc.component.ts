...
@Component({
  selector: 'app-market-value-calc',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './market-value-calc.component.html',
  styleUrl: './market-value-calc.component.scss'
})

export class MarketValueCalcComponent {
  currentStep = 0;
  steps = [0, 1, 2, 3, 4];
  submitted = false;
