...
@Component({
  selector: 'app-properties-references',
  standalone: true,
  imports: [CommonModule, MATERIAL_MODULES, MatProgressSpinner],
  templateUrl: './properties-references.component.html',
  styleUrl: './properties-references.component.scss'
})

export class PropertiesReferencesComponent {
